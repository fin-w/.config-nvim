...
vim.pack.add({
    ...
    'https://github.com/rachartier/tiny-inline-diagnostic.nvim',    -- Nicer diagnostics that don't extend off the screen.
    ...
    'https://github.com/MeanderingProgrammer/render-markdown.nvim', -- Pretty markdown files including in fzf-lua preview window.
