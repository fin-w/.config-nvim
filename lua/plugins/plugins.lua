return {
    ...
    { 'nvim-treesitter/nvim-treesitter-context', dependencies = { 'nvim-telescope/telescope.nvim', 'nvim-lua/plenary.nvim' } },                -- display location context at top
    { 'saghen/blink.cmp',                        dependencies = { 'rafamadriz/friendly-snippets', 'L3MON4D3/LuaSnip' },      version = '1.*' }, -- fast auto-completions
    { 'neovim/nvim-lspconfig',                   dependencies = { 'saghen/blink.cmp' } },                                                      -- sensible config for built-in neovim LS
    { 'L3MON4D3/LuaSnip',                        dependencies = { 'rafamadriz/friendly-snippets' } },                                          -- needed for snippets from blink
